...
obs = pd.DataFrame({
    "Case #": [34, 46, 88, 124, 1, 11, 34, 38, 26, 22, 34, 82, 46, 42, 46, 164],
    "Planet": [
        "HD 3167b", "HD 3167b", "K2-141b", "K2-141b", "LHS 1478b", "LHS 1478b",
        "TOI-1416b", "TOI-1416b", "TOI-1807b", "TOI-1807b", "TOI-431b", "TOI-431b",
        "TOI-500b", "TOI-500b", "TOI-561b", "TOI-561b",
    ],
    "Atmospheric Components": [
        "SO2, H2O", "CO2, N2", "SO2, H2O", "SO2, S2", "H2O, S2",
        "CO2, H2O", "CO2, SO2", "CO, N2", "CO, N2", "SO2, H2O",
        "SO2, S2", "SO2, H2O", "H2O, SO2", "H2O, H2", "H2O, O2", "H2O, SO2"
    ],
    "P_surf [bar]":           [10.90, 301.89, 169.22, 16.03, 317.21, 2693.22, 55.97, 437.02, 153.47, 13.57, 180.56, 256.23, 217.26, 20.38, 45.08, 16.7],
    "H Inventory [H_oceans]": [10, 20, 20, 30, 5, 5, 10, 20, 10, 5, 10, 20, 20, 20, 20, 20],
    "Redox State [IW]":       [4, 4, 4, 2, 0, 4, 4, 0, 0, 4, 4, 4, 4, 2, 4, 2],
    "MMW [g/mol]":            [53.05, 41.45, 57.86, 55.35, 34.93, 36.81, 46.02, 26.35, 25.39, 54.36, 60.00, 54.14, 40.00, 17.39, 25.32, 28.17],
    "T_day [K]":              [2495, 2567, 3023, 2935, 1218, 1303, 2254, 2390, 2571, 2441, 2717, 2850, 2803, 2734, 3193, 3343],
    "T_night [K]":            [1095, 1234, 1337, 1242, 335, 408, 1023, 1189, 1214, 1048, 1235, 1309, 1113, 1212, 1518, 1453],
    "N_obs":                  [15, 13, 9, 8, 10000, 10000, 52, 37, 22, 34, 10, 8, 38, 33, 39, 41],
    "N_bb":                   [18, 15, 8, 8, 9850, 9850, 53, 37, 21, 32, 10, 10, 36, 38, 34, 41],
    "T_obs [hours]":          [345.60, 299.52, 60.48, 53.76, 468000.00, 468000.00, 1248.00, 888.00, 290.40, 448.80, 117.60, 94.08, 501.60, 435.60, 421.20, 442.8],
    "Retrieval Evidence":     [2.4, 1.7, 2.8, 2.5, np.nan, np.nan, 4.9, 1.9, 1.7, 4.8, 2.4, 2.1, 2.7, 2.1, 2.0, np.nan],
    "N_day":                  [25, 25, 11, 11, np.nan, np.nan, 25, 70, 45, 33, 16, 17, 55, 70, 75, np.nan],
    "Evidence_day":          [5.2, 4.7, 4.7, 4.8, np.nan, np.nan, 4.9, 5.2, 4.9, 4.8, 5.2, 4.9, 5.2, 5.1, 4.9, np.nan],
    "A_obs":          [0.897, 0.890, 0.896, 0.893, np.nan, np.nan, 0.911, 0.904, 0.894, 0.906, 0.902, 0.896, 0.905, 0.912, 0.863, 0.874],
    "σ_obs":          [0.179, 0.176, 0.158, 0.156, np.nan, np.nan, 0.183, 0.181, 0.176, 0.177, 0.171, 0.163, 0.180, 0.180, 0.172, 0.175],
    "N_pc":          [6, 7, 4, 4,np.nan, np.nan, 18, 17, 12, 13, 4, 4, 15, 12, 29, 26],
    "A_obs_AIRS":     [0.870, 0.859, 0.862, 0.858, np.nan, np.nan, 0.885, 0.873, 0.862,0.879, 0.873, 0.866, 0.874, 0.881, 0.827, 0.839],
    "σ_obs_AIRS":     [0.174, 0.166, 0.166, 0.164, np.nan, np.nan, 0.177, 0.175, 0.169, 0.172, 0.164, 0.157, 0.172, 0.173, 0.165, 0.168],
    "N_pc_AIRS":     [7, 8, 5, 5, np.nan, np.nan, 19, 19, 14, 15, 5, 5, 19, 15, 39, 36],
})
