...
obs = pd.DataFrame({
    ...
    "N_obs":                  [15, 13, 9, 8, 10000, 10000, 52, 37, 22, 34, 10, 8, 38, 33, 39, 42],
    "N_bb":                   [18, 15, 8, 8, 9850, 9850, 53, 37, 21, 32, 10, 10, 36, 38, 34, 42],
    "T_obs [hours]":          [345.60, 299.52, 60.48, 53.76, 468000.00, 468000.00, 1248.00, 888.00, 290.40, 448.80, 117.60, 94.08, 501.60, 435.60, 421.20, 453.6],
    "Retrieval Evidence":     [2.4, 1.7, 2.8, 2.5, np.nan, np.nan, 4.9, 1.9, 1.7, 4.8, 2.4, 2.1, 2.7, 2.1, 1.9, 3.4],
