...
obs = pd.DataFrame({
    ...
    "A_obs_AIRS":     [0.870, 0.859, 0.862, 0.858, np.nan, np.nan, 0.885, 0.873, 0.862,0.879, 0.873, 0.866, 0.874, 0.881, 0.827],
    "σ_obs_AIRS":     [0.174, 0.166, 0.166, 0.164, np.nan, np.nan, 0.177, 0.175, 0.169, 0.172, 0.164, 0.157, 0.172, 0.173, 0.165],
    "N_pc_AIRS":     [7, 8, 5, 5, np.nan, np.nan, 19, 19, 14, 15, 5, 5, 19, 15, 39],
})
